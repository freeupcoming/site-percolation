...
def extract_images(filename, lx, ly):
...
def read_data_sets(nlabels, lx, ly, train_dir, fake_data=False, one_hot=False):
    ...
    z = 1.
    ly_1 = numpy.math.ceil(lx**z)
    # ly_1 = 119
    TRAIN_IMAGES = 'xtrain_' + str(lx) + '_' + str(ly_1) + '.npy'
    TRAIN_LABELS = 'ytrain_' + str(lx) + '_' + str(ly_1) + '.dat'
    TEST_IMAGES = 'xtest_' + str(lx) + '_' + str(ly_1) + '.npy'
    TEST_LABELS = 'ytest_' + str(lx) + '_' + str(ly_1) + '.dat'
    VALIDATION_SIZE = 0
    local_file = maybe_download(TRAIN_IMAGES, train_dir)
    train_images = extract_images(local_file, lx, ly)
    print('after train images xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')
    local_file = maybe_download(TRAIN_LABELS, train_dir)
    train_labels = extract_labels(nlabels, local_file, one_hot=one_hot)

    local_file = maybe_download(TEST_IMAGES, train_dir)
    test_images = extract_images(local_file, lx, ly)
